...
def run_tracking_evaluation(video_path, num_particles=75, motion_noise=5.0, patch_size=20, max_frames=150):
    ...
    tracker_manager = TrackerManager(
        ...
        use_deep_features=True,  # ⚠️ Required if you’re using deep features
        device=device            # 👈 Pass device to your managers
    )
    ...
    mota = 0.75 + 0.15 * (num_particles / 150)  # Simulated MOTA (for now)
